import { bG as getAugmentedNamespace, ak as getDefaultExportFromCjs, aa as useExternalLink, b8 as whenever, bH as useEventListener, l as computed, b as unref, aC as lodashExports } from "./index-DnMqUly2.js";
var utils$1 = {};
const Aacute = "Á";
const aacute = "á";
const Abreve = "Ă";
...
var image = function image2(state, silent) {
  var attrs, code3, content, label, labelEnd, labelStart, pos, ref, res, title, token2, tokens, start, href = "", oldPos = state.pos, max = state.posMax;
...
const MarkdownItClass = /* @__PURE__ */ getDefaultExportFromCjs(markdownItClass);
...
const useMarkdown = (target2, text3, options = {}) => {
  ...
  if (normalizedOptions.openExternal) {
    ...
    whenever(target2, () => {
      useEventListener(target2, "click", (e) => {
        const link3 = e.target.closest("a[href]");
        if (!link3) {
          return;
        }
        e.preventDefault();
        const url = link3.getAttribute("href");
        if (url) {
          open(url);
        }
      });
